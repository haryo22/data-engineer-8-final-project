...
docker-build-slim:
	@chmod 777 logs/
	@chmod 777 notebooks/
	@docker network inspect projectde-network >/dev/null 2>&1 || docker network create projectde-network
	@docker build -t projectde-dibimbing/jupyter -f ./docker/Dockerfile.jupyter .
...
docker-build:
	...
	@docker network inspect projectde-network >/dev/null 2>&1 || docker network create projectde-network
	@echo '__________________________________________________________'
	@docker build -t projectde-dibimbing/spark -f ./docker/Dockerfile.spark .
	@echo '__________________________________________________________'
	@docker build -t projectde-dibimbing/airflow -f ./docker/Dockerfile.airflow .
	@echo '__________________________________________________________'
	@docker build -t projectde-dibimbing/jupyter -f ./docker/Dockerfile.jupyter .
	@echo '==========================================================='
...
docker-build-arm:
	...
	@docker build -t projectde-dibimbing/spark -f ./docker/Dockerfile.spark .
	@echo '__________________________________________________________'
	@docker build -t projectde-dibimbing/airflow -f ./docker/Dockerfile.airflow-arm .
	@echo '__________________________________________________________'
	@docker build -t projectde-dibimbing/jupyter -f ./docker/Dockerfile.jupyter .
	@echo '==========================================================='
...
postgres-bash:
	@docker exec -it projectde-postgres bash
